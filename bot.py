...
TOKEN = os.environ.get('TOKEN', '7950596592:AAEwGqA-7mzRvOOAGDIcNBxLs78pQoKgp3o')
ADMIN_ID = int(os.environ.get('ADMIN_ID', '0'))
PHONE_NUMBER = os.environ.get('PHONE_NUMBER', '+7XXXXXXXXXX')
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'price':
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("200₽ - Коллаж", callback_data='service_200')],
        ...
        await query.edit_message_text(
            ...
            "Или мое портфолио: [добавьте ссылку]",
            reply_markup=InlineKeyboardMarkup(keyboard)
        )
